# New Book Copy — Draft (Phase 4B-copywriting)

Draft marketing/product copy for the 7 confirmed-available new titles. This is a **draft for review** — none of this has been added to the Astro content collection (`web/src/content/books/`) yet. Word/character counts on every constrained field were verified programmatically, not by eye.

Confirmed commerce facts used throughout (none invented):
- All 7 titles: **available**
...
- **Confirmed working display title:** Abuelita & Baby
- **Recommended URL slug:** `abuelita-and-baby`
- **Marketing hook:** A tender celebration of the love only a grandmother can give.
- **Short shop-card description (41 words):**
  "Abuelita & Baby" follows the warm, everyday magic shared between a grandmother and her grandchild — Spanish lullabies, kitchen dancing, garden mornings, and hugs that last a little longer. A gentle tribute to the bond that shapes a family's earliest memories.
- **Full product-page description (129 words):**
...
- **Confirmed working display title:** Black, White & Baby
- **Recommended URL slug:** `black-white-and-baby`
- **Marketing hook:** A family where love comes first, and every part of Baby belongs.
- **Short shop-card description (41 words):**
  "Black, White & Baby" celebrates a family built on love without borders — a Black father, a white mother, and the baby who belongs fully to both. A tender story about identity, belonging, and the joy of being wholly, beautifully yourself.
- **Full product-page description (137 words):**
...
- **Confirmed working display title:** Christmas & Baby
- **Recommended URL slug:** `christmas-and-baby`
- **Marketing hook:** The wonder of Christmas, wrapped in family and warmth.
- **Short shop-card description (36 words):**
  "Christmas & Baby" follows Baby Karter through a season of twinkling lights, wrapped gifts, and family traditions passed down with love. A cozy celebration of wonder, warmth, and togetherness during the most magical time of year.
- **Full product-page description (148 words):**
...
- **Confirmed working display title:** Halloween & Baby
- **Recommended URL slug:** `halloween-and-baby`
- **Marketing hook:** All the magic of Halloween, none of the scares.
- **Short shop-card description (37 words):**
  "Halloween & Baby" is a playful celebration of costumes, decorations, and imagination — sparkly, giggly, and never spooky. Baby Karter discovers the magic of the season surrounded by family, treats, and just the right amount of make-believe.
- **Full product-page description (123 words):**
...
- **Confirmed working display title:** Mexican & Baby
- **Recommended URL slug:** `mexican-and-baby`
- **Marketing hook:** A joyful celebration of heritage, family, and pride.
- **Short shop-card description (38 words):**
  "Mexican & Baby" is a joyful celebration of heritage, family, and pride — music, food, and traditions passed down with love. A baby discovers the richness of Mexican culture surrounded by the people and rhythms that shape home.
- **Full product-page description (129 words):**
...
## 6. Puertorican, Boricua & Baby

*Exact working title and spelling preserved as instructed — not corrected to "Puerto Rican."*

- **Confirmed working display title:** Puertorican, Boricua & Baby
- **Recommended URL slug:** `puertorican-boricua-and-baby`
- **Marketing hook:** Boricua pride, sung and danced from generation to generation.
- **Short shop-card description (39 words):**
  "Puertorican, Boricua & Baby" celebrates the rhythm, pride, and warmth of Puerto Rican culture — music, dancing, family, and every beautiful shade of Boricua identity. A joyful, heartfelt tribute to heritage carried proudly from one generation to the next.
- **Full product-page description (134 words):**
...
- **Confirmed working display title:** Thanksgiving & Baby
- **Recommended URL slug:** `thanksgiving-and-baby`
- **Marketing hook:** Family, gratitude, and a table big enough for everyone.
- **Short shop-card description (37 words):**
  "Thanksgiving & Baby" follows Baby Karter through a table full of family, laughter, and traditions worth giving thanks for. A warm celebration of gratitude, togetherness, and the cousins and grandparents who make the holiday feel like home.
- **Full product-page description (120 words):**
...
- Every short shop-card description and full product-page description was word-counted programmatically (not by eye) against the required 35–55 and 120–180 word ranges. All 7 pass.
- Every SEO title and SEO description was character-counted programmatically against the required <60 and 140–160 character ranges. All 7 pass.
- No age ranges, Stripe Price IDs, or reviews were invented anywhere in this document.
- No exaggerated educational claims, invented plot events, or generic filler phrases were used.

## Not done in this phase (by design)

- No Astro content-collection entries have been created for these 7 titles.
- No Stripe Products/Prices have been created or modified.
- No images have been copied, renamed, or optimized.
- `client/`, `server/`, and all image files remain untouched.
